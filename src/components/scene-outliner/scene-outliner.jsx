...
import styles from './scene-outliner.css';
...
const SceneOutlinerComponent = function (props) {
    const {
        editingTarget,
        hoveredTarget,
        intl,
    ...
    return (
        <Box
            className={styles.sceneOutliner}
            {...componentProps}
        >
...
SceneOutlinerComponent.propTypes = {
...
export default injectIntl(SceneOutlinerComponent);
