...
import SceneOutlinerItemComponent from '../components/scene-outliner-item/scene-outliner-item.jsx';

const dragThreshold = 3; // Same as the block drag threshold

class SceneOutlinerItem extends React.PureComponent {
    constructor (props) {
        super(props);
        bindAll(this, [
            'getCostumeData',
