...
describe('Loading scratch gui', () => {
    ...
    describe('Loading projects by ID', () => {
        ...
        xtest('Creating new project resets active tab to Code tab', async () => {
            await loadUri(uri);
            await new Promise(resolve => setTimeout(resolve, 2000));
        ...
        xtest('Not logged in->made no changes to project->create new project should not show alert', async () => {
            await loadUri(uri);
            await new Promise(resolve => setTimeout(resolve, 2000));
            await clickXpath(
                '//div[contains(@class, "menu-bar_menu-bar-item") and ' +
        ...
        xtest('Not logged in->made a change to project->create new project should show alert', async () => {
            await loadUri(uri);
            await new Promise(resolve => setTimeout(resolve, 2000));
